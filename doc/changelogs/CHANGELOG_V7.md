...
<a id="7.1.0"></a>
## 2016-11-07, Version 7.1.0 (Current), @evanlucas
...
* **src**: add NODE_PRESERVE_SYMLINKS environment variable that has the same effect as the `--preserve-symlinks` flag (Marc Udoff) [#8749](https://github.com/nodejs/node/pull/8749)
